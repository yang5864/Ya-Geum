...
const { fetchTransactions, setCurrentMonth, setSelectedFilter } = budgetStore
...
<template>
  <main class="relative h-full overflow-y-auto bg-kb-app-bg pb-28 text-kb-profit">
    ...
    <button
      type="button"
      aria-label="거래 추가"
      class="fixed bottom-[96px] right-6 z-20 grid h-[72px] w-[72px] place-items-center rounded-full bg-kb-yellow text-kb-dark-gray shadow-lg"
    >
